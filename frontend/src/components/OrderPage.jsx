...
export default function OrderPage(
  ...
  useTokenExpirationWatcher(); 
    ...
    const validatePaymentDetails = (creditCardNumber, expiryDate, cardOwnerId) => {
    ...
    const handleOrder = async () => {
        ...
        const { cartItems } = await response.json();
            ...
            try {
                ...
                if (paymentMethod === "saved"&& !validatePaymentDetails(creditCardNumber,expiryDate,cardOwnerId)) {
                        alert("פרטי התשלום אינם תקינים. בדוק את מספר הכרטיס, התוקף או מספר הזהות.");
                        return;
                }
                ...
                try {
                    const response = await fetch(`${apiUrl}/api/validatePayment`, {
                        method: "POST",
                        headers: {
                    ...
                    if (!result.success) {
                        alert("פרטי התשלום אינם תקינים: " + result.message);
                        return; // עצירה אם יש שגיאה
                    }
                } catch (error) {
